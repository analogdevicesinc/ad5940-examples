...
FreqParams_Type AppIMPGetFreqParam(float freq)
{
  ...
  float AdcRate = ADCRATE_800KHZ_VALUE;
  ...
  if(freq < 0.1)
  {
    ...
    freq_params.ADCSinc2Osr = ADCSINC2OSR_667;
  ...
  {
    freq_params. DftSrc = DFTSRC_SINC2NOTCH;
    freq_params.ADCSinc2Osr = ADCSINC2OSR_533;
    freq_params.ADCSinc3Osr = ADCSINC3OSR_4;
    freq_params.DftNum =DFTNUM_8192;
    freq_params.NumClks = 0;
    freq_params.HighPwrMode = bFALSE;
  ...
  else if(freq < 5) //below this is bad.
  {
    freq_params. DftSrc = DFTSRC_SINC2NOTCH;
    freq_params.ADCSinc2Osr = ADCSINC2OSR_533;
    freq_params.ADCSinc3Osr = ADCSINC3OSR_2;
    freq_params.DftNum =DFTNUM_4096;
    freq_params.NumClks = 0;
    freq_params.HighPwrMode = bFALSE;
    return freq_params;		
  }
  ...
  {
    freq_params. DftSrc = DFTSRC_SINC2NOTCH;
    freq_params.ADCSinc2Osr = ADCSINC2OSR_44;
    freq_params.ADCSinc3Osr = ADCSINC3OSR_2;
    freq_params.DftNum = DFTNUM_4096;
    freq_params.NumClks = 0;
    freq_params.HighPwrMode = bFALSE;
  ...
  {
    freq_params. DftSrc = DFTSRC_SINC2NOTCH;
    freq_params.ADCSinc2Osr = ADCSINC2OSR_22; //ADCSINC2OSR_178 ADCSINC2OSR_22
    freq_params.ADCSinc3Osr = ADCSINC3OSR_2; //ADCSINC3OSR_4
    freq_params.DftNum = DFTNUM_8192; //DFTNUM_8192  DFTNUM_4096
    freq_params.NumClks = 0;
    freq_params.HighPwrMode = bFALSE;
    return freq_params;		
  }
  ...
  {
    freq_params.DftSrc = DFTSRC_SINC3; //DFTSRC_SINC3 DFTSRC_SINC2NOTCH
    freq_params.ADCSinc2Osr = ADCSINC2OSR_22; //ADCSINC2OSR_89
    freq_params.ADCSinc3Osr = ADCSINC3OSR_2; // ADCSINC3OSR_2 ADCSINC3OSR_4
    freq_params.DftNum = DFTNUM_16384; //DFTNUM_16384 DFTNUM_8192
    freq_params.NumClks = 0;
    freq_params.HighPwrMode = bFALSE;
...
AD5940Err AppIMPCheckFreq(float freq)
{
  ...
  freq_params = AppIMPGetFreqParam(freq);
