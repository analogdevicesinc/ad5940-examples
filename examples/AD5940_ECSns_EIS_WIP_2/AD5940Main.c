...
void AD5940ImpedanceStructInit(void)
{
  ...
  *	 Output waveform = DacVoltPP * ExcitBufGain * HsDacGain 
	...
	*/
	...
	pImpedanceCfg->SweepCfg.SweepEn = bTRUE;//bFALSE;
	pImpedanceCfg->SweepCfg.SweepStart = 0.1f;	/* Start from 1kHz */
	pImpedanceCfg->SweepCfg.SweepStop = 180e3f;		/* Stop at 100kHz */
